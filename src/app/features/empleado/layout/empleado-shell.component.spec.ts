...
import { EmpleadoShellComponent } from './empleado-shell.component';

describe('EmpleadoShellComponent', () => {
  let fixture: ComponentFixture<EmpleadoShellComponent>;
  let component: EmpleadoShellComponent;
  ...
  beforeEach(() => {
    ...
    authService = {
      profile: signal<Profile | null>({ nombre_completo: 'Luis Ruiz', empresa: { nombre: 'Acme', pausada: false } } as Profile),
      logout: jasmine.createSpy('logout').and.resolveTo(),
    };
    responsive = { isHandset: signal(false), isTabletOrHandset: signal(false) };

    TestBed.configureTestingModule({
      imports: [EmpleadoShellComponent],
      providers: [
    ...
    TestBed.overrideComponent(EmpleadoShellComponent, {
      add: { providers: [{ provide: MatDialog, useValue: dialog }] },
    });
    fixture = TestBed.createComponent(EmpleadoShellComponent);
  ...
  describe('banner de empresa pausada', () => {
    it('se muestra cuando la empresa del perfil está pausada', () => {
      authService.profile.set({ nombre_completo: 'Luis', empresa: { nombre: 'Acme', pausada: true } } as Profile);
      fixture.detectChanges();
